<template>
  <div class="deatils">
    ...
    <div class="signle">
      <div class="header"><NuxtLink to="/">首页</NuxtLink> > <NuxtLink to="/forum/home">论坛</NuxtLink> > 帖子详情</div>
      <ul class="photos">
      ...
      <div class="content">
        <div class="text">
          ...
          <ul class="discuss" v-if="discuss.length != 0">
        ...
        <div class="comment">
          ...
          <div class="btn">
            ...
            <el-button type="info" @cliclk="textarea = ''">清空</el-button>
          </div>
        </div>
      </div>
    </div>
